...
public class EntityHelper {
    ...
    public static String getColumnName(String propertyName, boolean isMapUnderscoreToCamelCase)
    {
    ...
    public static String underscoreToCamel(String underlineStr)
    {
    ...
    public static Method findSetterMethod(String propertyName, Class<?> entityClass, Class<?>... paramTypes)
    {
        StringBuilder sb = new StringBuilder();
        sb.append(SET);
        sb.append(Character.toUpperCase(propertyName.charAt(0)) + propertyName.substring(1));
    ...
    public static boolean methodParameterTypeCheck(Method method, Class<?> expectedType)
    {
    ...
    public static boolean methodReturnTypeCheck(Method method, Class<?> exptectedType)
    {
