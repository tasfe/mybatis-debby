 ...
 */
public class XPaginationSuffixSqlFragmentElementGenerator extends XAbstractXmlElementGenerator {

	@Override
	public void addElements(XmlElement parentElement) {
		XmlElement answer = new XmlElement("sql");
		answer.addAttribute(new Attribute("id", XConstants.SUFFIX_PAGINATION_SQL_FRAGMENT_ID));
		...
		dialect.processLimitSuffixSqlFragment(answer);;
